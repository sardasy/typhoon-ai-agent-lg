...
class TestValidateCodeAgainstApi:
    async def test_unknown_hil_call_warned(self, tmp_path, monkeypatch):
        ...
        # Prevent codegen.yaml from overriding the env-var path
        from src.nodes import validate_code as vc_mod
        monkeypatch.setattr(vc_mod, "_load_codegen_config", lambda: {})
