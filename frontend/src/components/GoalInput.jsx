  ...
  return (
    <div className="bg-gray-900 border border-gray-800 rounded-xl p-5 shadow-xl">
      <div className="flex items-center gap-2 mb-3">
        ...
        <h2 className="text-sm font-semibold text-gray-200 tracking-tight">Test Goal</h2>
        <span className="ml-auto text-xs text-gray-600">Natural language input</span>
      </div>
      ...
      <form onSubmit={handleSubmit} className="flex gap-3">
        <input
          ...
          disabled={isRunning}
          className="flex-1 bg-gray-800 border border-gray-700 rounded-lg px-4 py-2.5 text-sm text-gray-200 placeholder-gray-600 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500/50 disabled:opacity-50 transition-colors"
        />
        {isRunning ? (
          <button
            type="button"
